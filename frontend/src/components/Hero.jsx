  ...
  return (
    <section className="bg-[#1E2A38] text-white px-14 py-16 md:flex md:items-center md:justify-between">
      ...
      <div className="md:w-1/2 space-y-6">
        ...
        <button className="bg-[#3CB4AC] hover:bg-[#16fef4] hover:text-black hover:border-black border text-white px-6 py-3 rounded-full font-medium transition duration-300">
          Book a Fitting
        </button>
      </div>
